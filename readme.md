...
traffic was being handled securely over HTTPS. Utilized advanced display filters to isolate TLS Handshakes and 
SNI (Server Name Indication) data, proving that encrypted connection to 
Wikipedia was established correctly.

3. Firewall Policy Enforcement
Task: Hardened a Windows endpoint by blocking insecure, clear-text 
protocols.
Created Outbound Firewall Rules in Windows Defender with 
